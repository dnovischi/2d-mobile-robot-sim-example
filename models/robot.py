...
class Robot: # Khepera III robot 
  ...
  def __init__( self, x = 0.0, y = 0.0, theta = 0.0 ):
    ...
    polygon = Polygon( K3_BOTTOM_PLATE )
      
    # geometry
    self.geometry = polygon
    self.global_geometry = polygon.get_transformation_to_pose(Pose(x,y,theta)) # actual geometry in world space
    ...
    self.supervisor = Supervisor( RobotSupervisorInterface( self ),
                                  K3_WHEEL_RADIUS, K3_WHEEL_BASE_LENGTH, K3_WHEEL_TICKS_PER_REV, K3_SENSOR_POSES, K3_SENSOR_MAX_RANGE, [0.0, 0.0],[x,y,theta] )
